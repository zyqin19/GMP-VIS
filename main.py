...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--pretrained_weights', type=str, default="/home/qinzheyun/PycharmProjects/data/"
                                                                  "pretrained/vistr/vistr_r101.pth",
    ...
    parser.add_argument('--num_queries', default=240, type=int,
    ...
    parser.add_argument('--ytvos_path', type=str, default='/home/qinzheyun/Data/YouTube/')
    parser.add_argument('--remove_difficult', action='store_true')

    parser.add_argument('--output_dir', default='/home/qinzheyun/PycharmProjects/data/output/vistr/vistr_r101',
